...
void dev_initCoreElems(D3DCore* pCore) {
    ...
    bindRitemReferenceWithLayers(pCore, "box", { {"alpha_test", 0}, {"wireframe", 0} });
    ...
    bindRitemReferenceWithLayers(pCore, "hill", { {"solid", 0}, {"wireframe", 0} });
    // Hill 2
    ...
    bindRitemReferenceWithLayers(pCore, "hill2", { {"solid", 0}, {"wireframe", 0} });
    ...
    bindRitemReferenceWithLayers(pCore, "lake", { {"alpha", 0}, {"alpha_cartoon", 0}, {"wireframe", 0} });
