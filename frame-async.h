...
struct RenderItem {
    ...
    ObjConsts constData;
    // To draw an object, we need 2 sets of basic data: unique object property & vertex geometry data.
    // objConstBuffIdx helps to find the unique object property in the object constants buffer, and
    // mesh stores the vertex geometry data. We also need an extra topologyType to switch
