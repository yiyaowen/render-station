...
*/
	...
	float4 v[4];
	v[0] = float4(centerW - halfWidth * right + halfHeight * up, 1.0f);
	v[1] = float4(centerW - halfWidth * right - halfHeight * up, 1.0f);
	v[2] = float4(centerW + halfWidth * right + halfHeight * up, 1.0f);
	v[3] = float4(centerW + halfWidth * right - halfHeight * up, 1.0f);
